...
async function customValidation(textDocument: TextDocument, diagnostics: Diagnostic[]): Promise<void> {
...
async function validateTextDocument(textDocument: TextDocument, diagnostics: Diagnostic[]): Promise<void> {
